...
class Query:
    ...
    def create_connection():
        ...
        try:
            ...
            #connection_string = MySQLdb.connect(host = 'localhost', port = 3306, user = 'root', passwd = 'DM@bd!987', db = 'dmabdcom_gpstracker')
            connection_string = MySQLdb.connect(host = 'localhost', port = 3306, user = 'root', passwd = '', db = 'dmabdcom_gpstracker')
