# Database connection & query file for Water Meter Reading
# The database connection is not terminated after insertion
...
class Query:
	...
	def create_connection():
		...
		try:
			...
			#connection_string = MySQLdb.connect(host = 'localhost', port = 3306, user = 'root', passwd = '', db = 'saudi_water_tank')
			...
			connection_string = MySQLdb.connect(host = 'dma-bd.com', port = 3306, user = 'dmabdcom_power', passwd = 'dmabd987', db = 'dmabdcom_utility_power')
